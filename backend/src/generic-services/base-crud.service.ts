import { WasNotFound_EX, WasNotUpdated_EX } from './../exceptions/db-exceptions'
import { Repository } from 'typeorm'
import {
  Crud_WO_Owner,
  Crud_W_Owner,
  FindAll_W_Owner,
} from 'src/generic-interfaces/base-crud-interface'
import { DEFAULT_PORTION } from 'src/constants/db.constants'
import { forPagination } from 'src/SharedUtils.ts/transforms/transforms'
import {
