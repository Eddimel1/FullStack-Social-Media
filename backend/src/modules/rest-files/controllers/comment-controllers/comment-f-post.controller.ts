...
import { CommentForPostService_U } from 'src/modules/upload-and-remove/for-comment/services/for-post.service'

@Controller('comment')
export class Comment_F_Post_Controller {
  constructor(private readonly forCommentService: CommentForPostService_U) {}
  @Public()
