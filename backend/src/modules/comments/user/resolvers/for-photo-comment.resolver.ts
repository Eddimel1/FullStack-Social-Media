...
import { FindAllComment_F_Photo_U } from '../dto/comment-for-photo/output.dto'
...
export class Comment_F_Photo_Resolver_U {
  ...
  @Query(() => FindAllComment_F_Photo_U)
  async findAllCommentsForPhoto_U(@Args('photoId') photoId: number) {
    return await this.commentForPhotoService.findAllPublished(photoId, 'comments')
  }
