...
import { Comment_F_Video_U } from 'src/modules/rest-files/types/user-types'

const storageP = '../../storage'
@Injectable()
export class CommentForVideoService_U extends Base_Upload_Remove_Service<
...
> {
  constructor(
    private readonly postImageService_U: Image_F_Comment_F_Video_Service_U,
    private readonly postVideoService_U: Video_F_Comment_F_Video_Service_U,
    private readonly postAudioService_U: Audio_F_Comment_F_Video_Service_U,
  ...
  async _invokeAppropriateService_Up(
    ...
    const relation = folder as Comment_F_Video_U
    switch (relation) {
      case 'image_f_comment_f_video_u': {
      ...
      case 'video_f_comment_f_video_u': {
      ...
      case 'audio_f_comment_f_video_u': {
