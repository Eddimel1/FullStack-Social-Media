...
import { Reply_F_Post_G } from 'src/modules/rest-files/types/group-types'

const storageP = '../../storage'

@Injectable()
export class ReplyForPostService_G extends Base_Upload_Remove_Service<
...
> {
  constructor(
    private readonly image_F_Reply_F_Post_Service_G: Image_F_Reply_F_Post_Service_G,
    private readonly video_F_Reply_F_Post_Service_G: Video_F_Reply_F_Post_Service_G,
    private readonly audio_F_Reply_F_Post_Service_G: Audio_F_Reply_F_Post_Service_G,
  ...
  async _invokeAppropriateService_Up(
    ...
    const relation = folder as Reply_F_Post_G
    switch (relation) {
      case 'image_f_reply_f_post_g': {
        return await this.image_F_Reply_F_Post_Service_G.insertOne(
          mainId,
          ownerId,
          url,
          file_name,
      ...
      case 'video_f_reply_f_post_g': {
        return await this.video_F_Reply_F_Post_Service_G.insertOne(
          mainId,
          ownerId,
          url,
          file_name,
      ...
      case 'audio_f_reply_f_post_g': {
        return await this.audio_F_Reply_F_Post_Service_G.insertOne(
          mainId,
          ownerId,
          url,
          file_name,
  ...
  async _invokeAppropriateService_Del(
    ...
    switch (relation) {
      case 'image_f_reply_f_post_g': {
        return await this.image_F_Reply_F_Post_Service_G.deleteOneByOwnerId(
          id,
          file_name,
          'image_f_reply_f_post_g',
        )
      ...
      case 'video_f_reply_f_post_g': {
        return await this.video_F_Reply_F_Post_Service_G.deleteOneByOwnerId(
          id,
          file_name,
          'video_f_reply_f_post_g',
        )
      ...
      case 'audio_f_reply_f_post_g': {
        return await this.audio_F_Reply_F_Post_Service_G.deleteOneByOwnerId(
          id,
          file_name,
          'audio_f_reply_f_post_g',
        )
