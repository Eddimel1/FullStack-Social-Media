...
import { CreateCommentForVideo_I_G } from '../dto/comment-for-video/input.dto'
...
export class CommentForVideoService_DB_G extends Base_Crud_W_FindAll<CommentForVideoEntity_G> {
  ...
  async create(createCommentInput: CreateCommentForVideo_I_G) {
    const comment_f_photo = new CommentForVideoEntity_G()
